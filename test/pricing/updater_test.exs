defmodule Pricing.UpdaterTest do
  ...
  @data %Data{category: "home-furnishings", discontinued: false, 
              id: @ext_prod_id, name: "Nice Chair",
              price: "$30.25", price_cents: @price}
  
  @data_discontinued %Data{category: "home-furnishings", discontinued: true, 
                           id: @ext_prod_id, name: "Nice Chair",
                           price: "$30.25", price_cents: @price}


  # 4 product combinations for the two attributes name and price
  @valid_product_same_name_same_price %{external_product_id: @ext_prod_id, price: @price, product_name: "Nice Chair"}
  @valid_product_same_name_diff_price %{external_product_id: @ext_prod_id, price: @diff_price, product_name: "Nice Chair"}
  @valid_product_diff_name_same_price %{external_product_id: @ext_prod_id, price: @price, product_name: "Blue Chair"}
  @valid_product_diff_name_diff_price %{external_product_id: @ext_prod_id, price: @diff_price, product_name: "High Chair"}
