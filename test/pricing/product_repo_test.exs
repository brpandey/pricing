defmodule Pricing.ProductRepoTest do
  ...
  test "erroneous create" do
    ...
    assert [external_product_id: {"is invalid",
                                  [type: :integer, validation: :cast]}] = e
  end
  ...
  test "valid update" do
    ...
    assert {:ok, %Product{price: @updated_price1, product_name: "Nice Chair", external_product_id: 12345}} =
