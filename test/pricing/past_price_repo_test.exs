defmodule Pricing.PastPriceRepoTest do
  ...
  # with invalid product id of 0
  @invalid_attrs %{product_id: 0, price: 3025, percentage_change: -14.05}
  @valid_product_attrs %{
  ...
  test "check foreign key constraint for valid product id" do
    ...
    {:ok, %PastPrice{}} = %PastPrice{} |> PastPrice.changeset(params) |> Repo.insert()
  end
