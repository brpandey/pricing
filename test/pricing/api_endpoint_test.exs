defmodule Pricing.API.EndpointTest do
  ...
  test "valid json with one record" do
    ...
    records = [
      %Data{category: "home-furnishings",
            discontinued: false, id: 123456, name: "NiceChair", price: "$30.25", price_cents: 3025},
    ]
  ...
  test "valid json with two records" do
    ...
    records = [
      %Data{category: "home-furnishings",
            discontinued: false, id: 123456, name: "NiceChair", price: "$30.25", price_cents: 3025},
      %Data{category: "electronics", discontinued: true,
            id: 234567, name: "Black & White TV", price: "$43.77", price_cents: 4377}
    ]
