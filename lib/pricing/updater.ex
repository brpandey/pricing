defmodule Pricing.Updater do
  ...
  defp do_process(nil, %Data{discontinued: false} = recent) do
    {:ok, p} =
      Product.create(%{
        external_product_id: recent.id,
        product_name: recent.name,
        price: recent.price_cents
      })
  ...
  defp do_process(%Product{product_name: pname}, %Data{name: rname})
    ...
    msg =
      "Product Mismatch Error: Found product record with " <>
